  ...
  return (
    ...
    >
      <Box maxW="1200px" mx="auto" px={{ base: 4, md: 8 }}>
        <FadeUp>
          <VStack spacing={3} mb={12} textAlign="center">
            ...
            <Text
              ...
              maxW="520px"
            >
              Expert neuropsychological evaluation, cognitive assessment, and
              rehabilitation for TBI, ADHD, concussion, dementia, and more.
            </Text>
          </VStack>
        </FadeUp>
        ...
        <FadeUp delay={0.1}>
          <HStack justify="center" mt={10} flexDir={"column"}>
